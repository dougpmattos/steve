 ...
 * @author Douglas
 */
public final class NCLConnectorUtil {
    
     private NCLConnectorUtil(){}
	...
	public static String getParamValue(NCLConnectorParam connectorParam, NCLLink link){
        ...
        NCLLinkParam linkParam = NCLLinkUtil.getLinkParam(link,paramName);
        if(linkParam!=null){
        ...
        while(iterator.hasNext() && !foundBindParam){
            ...
            NCLBindParam bindParam = NCLBindUtil.getBindParam(bind,paramName);
            if(bindParam!=null){
