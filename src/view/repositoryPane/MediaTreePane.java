...
public class MediaTreePane extends TreeView<Object>{
    ...
    public MediaTreePane(){
    	...
    	ImageView rootIcon = new ImageView(new Image(getClass().getResourceAsStream("/view/repositoryPane/images/rootNode.png")));
    	ImageView imageIcon = new ImageView(new Image(getClass().getResourceAsStream("/view/repositoryPane/images/imageNode.png")));
	...
	public void add(Media media) {
        ...
        switch(media.getMediaType()){
            case IMAGE:
            	importedMediaIcon.setImage(new Image(getClass().getResourceAsStream("/view/repositoryPane/images/imageTreeItem.png")));
            	importedMediaTreeItem = new TreeItem<Object>(media, importedMediaIcon);
                image.getChildren().add(importedMediaTreeItem);
                break;
                
            case VIDEO:
            	importedMediaIcon.setImage(new Image(getClass().getResourceAsStream("/view/repositoryPane/images/videoTreeItem.png")));
            	importedMediaTreeItem = new TreeItem<Object>(media, importedMediaIcon);
                video.getChildren().add(importedMediaTreeItem);
                break;
                
            case AUDIO:
            	importedMediaIcon.setImage(new Image(getClass().getResourceAsStream("/view/repositoryPane/images/audioTreeItem.png")));
            	importedMediaTreeItem = new TreeItem<Object>(media, importedMediaIcon);
                audio.getChildren().add(importedMediaTreeItem);
                break;
                
            case TEXT:
            	importedMediaIcon.setImage(new Image(getClass().getResourceAsStream("/view/repositoryPane/images/textTreeItem.png")));
            	importedMediaTreeItem = new TreeItem<Object>(media, importedMediaIcon);
