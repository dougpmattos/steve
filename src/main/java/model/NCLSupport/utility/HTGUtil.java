...
import model.NCLSupport.NCLDocument.NCLMediaList;
...
public final class HTGUtil {
    ...
    public static boolean isMedia(NCLMediaList mediaList, String anchorId) throws XMLException{
	...
	public static ArrayList<NCLBind> getReferencedBinds(NCLSimpleAction simpleAction, NCLLink link) {
        ...
        while(iterator.hasNext()){
            ...
            String currentRoleName = NCLBindUtil.getRoleName(bind);
