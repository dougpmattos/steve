...
public class HotPresentationPropertyPane extends SensoryEffectPropertyPane {
    ...
    public HotPresentationPropertyPane(ApplicationController applicationController, SensoryEffectNode sensoryEffectNode){
        ...
        Text title = new Text(Language.translate("hot.properties"));
    ...
    public void populatePropertyPane(){
        ...
        HotPresentationProperty hotPresentationProperty =
                (HotPresentationProperty) sensoryEffectNode.getPresentationProperty();

        intensityValueTextField.setText(String.valueOf(hotPresentationProperty.getIntensityValue().getValue()));
        rangeFromTextField.setText(String.valueOf(hotPresentationProperty.getIntensityRange().getFromValue()));
        rangeToTextField.setText(String.valueOf(hotPresentationProperty.getIntensityRange().getToValue()));
