...
import model.spatialView.sensoryEffect.SnowPresentationProperty;
import model.spatialView.sensoryEffect.VibrationPresentationProperty;
import view.common.Language;

import java.util.function.UnaryOperator;

public class SnowPresentationPropertyPane extends SensoryEffectPropertyPane {
    ...
    public SnowPresentationPropertyPane(ApplicationController applicationController, SensoryEffectNode sensoryEffectNode){
        ...
        Text title = new Text(Language.translate("snow.properties"));
    ...
    public void populatePropertyPane(){
        ...
        SnowPresentationProperty snowPresentationProperty =
                (SnowPresentationProperty) sensoryEffectNode.getPresentationProperty();

        intensityValueTextField.setText(String.valueOf(snowPresentationProperty.getIntensityValue().getValue()));
        rangeFromTextField.setText(String.valueOf(snowPresentationProperty.getIntensityRange().getFromValue()));
        rangeToTextField.setText(String.valueOf(snowPresentationProperty.getIntensityRange().getToValue()));
