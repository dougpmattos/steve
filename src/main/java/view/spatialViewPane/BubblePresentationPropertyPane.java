...
import model.spatialView.sensoryEffect.BubblePresentationProperty;
import model.spatialView.sensoryEffect.VibrationPresentationProperty;
import view.common.Language;

public class BubblePresentationPropertyPane extends SensoryEffectPropertyPane {
    ...
    public BubblePresentationPropertyPane(ApplicationController applicationController, SensoryEffectNode sensoryEffectNode){
        ...
        Text title = new Text(Language.translate("bubble.properties"));
    ...
    public void populatePropertyPane(){
        ...
        BubblePresentationProperty bubblePresentationProperty =
                (BubblePresentationProperty) sensoryEffectNode.getPresentationProperty();

        intensityValueTextField.setText(String.valueOf(bubblePresentationProperty.getIntensityValue().getValue()));
        rangeFromTextField.setText(String.valueOf(bubblePresentationProperty.getIntensityRange().getFromValue()));
        rangeToTextField.setText(String.valueOf(bubblePresentationProperty.getIntensityRange().getToValue()));
